...
function fPalabrasEncontradas() {
    ...
    vPalabrasEncontradas.forEach(function (palabra) {
        ...
        palabrasEncontradas[palabra.longitud].push({nombre:palabra.nombre});
        palabrasEncontradas[palabra.longitud].push({puntos:palabra.puntos});
    });
    ...
    for (let x = 0; x < 10; x++) {
        ...
        let txt = document.createTextNode(vPalabrasEncontradas.nombre + ' - ' + vPalabrasEncontradas.puntos);
        td.appendChild(txt);
        tr.appendChild(td);
