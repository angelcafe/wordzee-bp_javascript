...
function cambiarValorBotones(e) {
    switch (e.srcElement.value) {
        case '':
            ...
            e.srcElement.value.className = 'btn btn-secondary rosa';
            break;
        case 'DL':
            e.srcElement.value = 'TL';
            e.srcElement.value.className = 'btn btn-secondary bg-success';
            break;
        case 'TL':
            e.srcElement.value = '';
            e.srcElement.value.className = 'btn btn-secondary info';
            break;
        default:
            break;
    }
