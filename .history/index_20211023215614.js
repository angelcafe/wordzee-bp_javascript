...
var palabrasEncontradas = new Object();
...
function fPalabrasEncontradas() {
    ...
    for (let x = 3; x < 8; x++) {
        ...
        palabrasEncontradas[x]['nombre'].split('').forEach(nombre => {
            for (let z = 0; z < nombre.length; z++) {
                let valor = puntos[letrasPalabra.split('')[z]] * puntosExtra[x][z] * ronda;
                if (x == 6) {
                    valor *= 2;
                } else if (x == 7) {
                    valor *= 3;
